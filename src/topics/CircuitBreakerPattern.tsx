          ...
          >
            <div style={{display: 'flex', gap: 30, justifyContent: 'center'}}>
              ...
              <div
                style={{
                  ...
                  borderRadius: 16,
                  opacity: fadeIn(frame, scene1End + 30, 25),
              ...
              <div
                style={{
                  ...
                  border: '3px solid #ef4444',
                  borderRadius: 16,
                  opacity: fadeIn(frame, scene1End + 90, 25),
                  boxShadow: '0 0 24px rgba(239, 68, 68, 0.4)',
                }}
              >
                <div style={{textAlign: 'center', marginBottom: 20}}>
              ...
              <div
                style={{
                  ...
                  borderRadius: 16,
                  opacity: fadeIn(frame, scene1End + 150, 25),
            ...
            <div
              style={{
                ...
                borderRadius: 12,
                opacity: fadeIn(frame, scene1End + 240, 30),
              }}
            >
          ...
          >
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 14,
                    opacity: fadeIn(frame, scene2End + 30 + i * 15, 20),
            ...
            <div
              style={{
                ...
                borderRadius: 16,
                opacity: fadeIn(frame, scene2End + 210, 30),
          ...
          >
                ...
                {[
                  ...
                  <div
                    ...
                    style={{
                      ...
                      color: '#d1fae5',
                      fontFamily: theme.typography.body.fontFamily,
                      opacity: fadeIn(frame, scene3End + 60 + i * 15, 15),
            ...
            <div
              style={{
                ...
                borderRadius: 12,
                marginBottom: 30,
                opacity: fadeIn(frame, scene3End + 150, 25),
              }}
            >
              <h3
                style={{
            ...
            <div
              style={{
                ...
                border: '3px solid #f59e0b',
                borderRadius: 16,
                opacity: fadeIn(frame, scene3End + 210, 30),
                boxShadow: '0 0 24px rgba(245, 158, 11, 0.4)',
              }}
            >
              <h3
